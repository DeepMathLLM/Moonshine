...
def build_system_prompt(
    ...
    if mode == "research":
        ...
        lines.append(
            ...
            "For problem generation, refinement, proof construction, counterexample search, verification, correction, consolidation, novelty recording, or memory work, load the corresponding skill definition before doing substantial work. "
