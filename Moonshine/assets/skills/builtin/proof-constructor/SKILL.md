...
- `search_knowledge`: Retrieve stored lemmas and conclusions.
...
- The archival pass will save clear proof-integration progress into `research_log.jsonl` for later retrieval.
