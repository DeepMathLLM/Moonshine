...
2. Check whether it follows from stored knowledge or prior work.
...
- `search_knowledge`: Check stored related conclusions.
...
- The archival pass will save clear lemma progress into `research_log.jsonl` for later retrieval.
