---
name: verify-overall
description: Verify the correctness of a mathematical solution by running pessimistic assumption, computation, and logic checks and requiring all three to pass.
...
## Summary
- Use this skill when an important solve step, subproblem solution, stored conclusion, or final blueprint needs a full correctness gate.
...
## Execution Steps
1. Restate the target subproblem or claim, the known conditions, and the solution process to be checked.
...
- `search_knowledge`: Retrieve stored lemmas, theorem statements, or definitions used in the audited solution.
