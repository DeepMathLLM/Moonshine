...
description: Extract durable project context, decisions, and progress updates from a conversation window.
...
## Usage Hint
- Use this skill to identify project-relevant research facts from a conversation window.
- Use it when recent discussion may contain durable project context, constraints, decisions, or research direction.

## Summary
- Capture durable project-scoped facts, decisions, and progress that should persist across sessions.
- Keep each proposal tied to the active project scope.

## Execution Steps
1. Read the trigger payload and confirm the active project.
2. Extract context updates, decisions, and progress markers that are likely to matter later.
...
- Allowed aliases: `project-context`, `project-decisions`, `project-progress`.
