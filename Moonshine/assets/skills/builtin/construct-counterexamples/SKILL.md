...
5. If a counterexample works, record which branch or claim it refutes.

## Tool Calls
- `query_memory`: Retrieve prior counterexamples and failed paths.
- `search_knowledge`: Check stored obstructions and known examples.
...
- The archival pass will save clear counterexamples into `research_log.jsonl` for later retrieval.
