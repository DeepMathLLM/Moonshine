...
## Purpose
- Provide built-in local filesystem tools under the `mcp_filesystem_*` names for read/write operations in explicitly allowed directories.
...
- In research mode, use project-relative paths such as `workspace/problem.md`, `memory/research_log.md`, `memory/research_log.jsonl`, or `references/notes/source.md`.
