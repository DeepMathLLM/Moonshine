...
5. Avoid presenting noisy transcript fragments.

## Tool Calls
- `query_memory`: Check whether a result already appears in prior memory.
...
- Prior consolidation notes can be retrieved from `research_log.jsonl` when relevant.
