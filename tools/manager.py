...
class ToolManager(object):
    ...
    def build_prompt_index(
        ...
        *,
        ...
        lines = ["Available tools (short descriptions and usage guidance; use matching tools when they provide evidence, retrieval, reading, verification, or experiments):"]
        ...
        lines.append("Use matching tools for retrieval, reading, verification, experiments, and evidence gathering; load a tool's full markdown definition with load_tool_definition when the summary and schema are insufficient.")
        return "\n".join(lines)
